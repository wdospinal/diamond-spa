...
function LeadDetailModal({
  ...
  const [priceCop, setPriceCop] = useState(
    booking.priceCop ? String(booking.priceCop) : "0",
  );
  ...
  const [status, setStatus] = useState<StageKey>(
    (booking.status || "pending") as StageKey,
  );
            ...
            <div className="p-3.5 rounded-xl bg-[#071322] border border-[#38bdf8]/40 shadow-inner flex flex-col gap-2">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-[10px] text-[#8a9299] font-mono">
                  {booking.adgroup
                    ? `Grupo de anuncios: ${booking.adgroup}`
                    : "Atribución de Ads"}
                </span>
              </div>
              ...
              {gclid ? (
                ...
                <div className="text-xs text-[#8a9299] italic bg-[#0a182c] p-2 rounded-lg border border-[#1e385c]">
                  Sin GCLID detectado (Tráfico Directo u Orgánico). Google Ads
                  emparejará este lead automáticamente por número de teléfono
...
export default function KanbanBoard({
  ...
  const [deletingBooking, setDeletingBooking] = useState<BookingRecord | null>(
    null,
  );
        ...
        className={`rounded-xl shadow-md transition-all flex flex-col gap-2 relative group ${
          ...
          isMobile
            ...
            : `p-3 hover:border-[#38bdf8]/70 hover:shadow-xl cursor-grab active:cursor-grabbing ${
                isBeingDragged
                  ? "opacity-30 scale-95 border-dashed border-[#38bdf8]"
                  : ""
              }`
        }`}
      >
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0 flex-1">
            <p
              className={`font-bold text-[#cfe5fa] truncate group-hover:text-[#38bdf8] transition-colors ${
            ...
            <p
              className={`text-[#8a9299] font-mono truncate mt-0.5 ${
          ...
          {waNum && (
            ...
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className={isMobile ? "w-5 h-5" : "w-3.5 h-3.5"}
              >
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.888-.788-1.489-1.761-1.663-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z" />
              </svg>
            </a>
        ...
        <div className="flex items-center justify-between py-1.5 px-2.5 rounded-lg bg-[#071322] border border-[#172c4c]">
          <span
            className={`text-[#a5cce6] font-medium truncate ${
          ...
          <span
            className={`font-bold font-mono text-[#34d399] ${
              isMobile ? "text-sm" : "text-xs"
            }`}
          >
        ...
        <div
          className={`flex items-center justify-between border-t border-[#172c4c] gap-1 ${
        ...
        >
          <button
            ...
            className={`rounded bg-[#071322] text-[#8a9299] hover:text-[#cfe5fa] hover:bg-[#172c4c] disabled:opacity-20 disabled:hover:bg-[#071322] font-bold transition-colors ${
              isMobile
                ? "px-4 py-2 text-base min-w-[44px] min-h-[44px] flex items-center justify-center"
                : "px-2 py-0.5 text-xs"
            }`}
          ...
          {isPaid ? (
            <span
              className={`font-bold text-[#34d399] inline-flex items-center gap-0.5 ${
      ...
      <div className="lg:hidden flex flex-col gap-4">
            ...
            return (
              ...
              >
                ...
                <span
                  ...
                  style={
                    isActive ? { color: col.accentColor } : { color: "#cfe5fa" }
                  }
                >
                  {count}
                </span>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-bold text-sm text-[#cfe5fa]">
                    {col.title}
                  </p>
              ...
              <div className="text-right">
                <p className="font-mono font-bold text-sm text-[#cfe5fa]">
        ...
        {(() => {
          ...
          const totalPages = Math.max(
            1,
            Math.ceil(list.length / CARDS_PER_PAGE),
          );
          const startIndex = (currentPage - 1) * CARDS_PER_PAGE;
          const visibleCards = list.slice(
            startIndex,
              ...
              >
                ...
                <div className="p-3.5 border-b border-[#172c4c] bg-[#0a182c] rounded-t-xl flex flex-col gap-2 relative">
                  ...
                  <div className="flex items-center justify-between text-[11px] font-medium pt-1 border-t border-[#172c4c]/60">
                    <span className="text-[#8a9299] text-[10px] truncate">
                      {col.subtitle}
                    </span>
