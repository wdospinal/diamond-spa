...
const SERVICES: Service[] = [
  ...
  { id: 'sensorial',  category: 'masajes',    name: 'Masaje Sensorial',         desc: 'Estimulación sensorial suave',             duration: '30 – 90 min', durationMin: 60, prices: [{ label: '30 min', value: 130000 }, { label: '60 min', value: 220000 }, { label: '90 min', value: 280000 }] },
