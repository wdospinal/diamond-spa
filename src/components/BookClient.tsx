...
const SERVICES = (lang: string): Service[] => [
  ...
  { id: 'sensitive', category: 'masajes', name: lang === 'en' ? 'Sensitive massage' : 'Masaje Sensitivo', desc: lang === 'en' ? 'Discover a relaxation experience designed to stimulate your senses through gentle movements and textured elements. Ideal for releasing stress, promoting calm, and enjoying a moment of well-being in an exclusive atmosphere.' : 'Descubre una experiencia de relajación diseñada para estimular los sentidos mediante movimientos suaves y elementos de textura. Ideal para liberar el estrés, promover la calma y disfrutar de un momento de bienestar en un ambiente exclusivo.', duration: '30 – 90 min', durationMin: 60, prices: [{ label: '30 min', value: 130000 }, { label: '60 min', value: 220000 }, { label: '90 min', value: 280000 }] },
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 40, background: `${C.card}f0`, backdropFilter: 'blur(12px)', borderBottom: `1px solid ${C.div}` }}>
        ...
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 16px', display: 'flex', alignItems: 'center', height: 56, gap: 0 }}>
          ...
          <button
            onClick={goBack}
            style={{
              background: 'none', border: 'none', cursor: (step === 'category' || (step === 'service' && allowedServiceIds && !initialSvc) || (initialSvc && step === initialStep)) ? 'default' : 'pointer',
