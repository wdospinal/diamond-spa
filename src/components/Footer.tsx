    ...
    <footer className="bg-surface-container-low py-20 px-6 md:px-12">
      <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          <h5 className="text-on-surface font-label text-xs tracking-widest uppercase mb-2">Contacto</h5>
          ...
          <div className="flex gap-4 mt-2">
            <a
              href="https://www.instagram.com/diamondmassagesmed/"
              target="_blank"
            ...
            <a href="https://wa.me/573145484227" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-primary transition-colors duration-200" aria-label="WhatsApp">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
