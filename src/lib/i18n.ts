...
const dict = {
  en: {
    ...
    services: {
      ...
      relatedServices: 'You may also like',
    ...
    book: {
      ...
      confirmedBody2: 'We look forward to welcoming you.',
    ...
    footer: {
      ...
      spaDay: 'Spa Day',
      spaElPoblado: 'Spa in El Poblado',
      spaNearMe: 'Spa Near Me',
      blog: 'Blog',
  ...
  es: {
    ...
    home: {
      ...
      relaxBody: 'Descubre una experiencia de relajación diseñada para estimular los sentidos mediante movimientos suaves y elementos de textura. Ideal para liberar el estrés, promover la calma y disfrutar de un momento de bienestar en un ambiente exclusivo.',
    ...
    services: {
      ...
      relatedServices: 'También te puede interesar',
    ...
    book: {
      ...
      confirmedBody2: 'Te esperamos con gusto.',
    ...
    footer: {
      ...
      hydrafacial: 'Hydrafacial',
      spaDay: 'Día de Spa',
      spaElPoblado: 'Spa en El Poblado',
      spaNearMe: 'Spa Cerca de Mí',
      blog: 'Blog',
