...
export async function generateMetadata({
  ...
  const seo = DEPILACION_GENDER_SEO.mujeres
  return mergeLandingMetadata(
    '/depilacion-mujeres',
    locale,
    { title: seo.metaTitle[locale], description: seo.metaDescription[locale] },
    {
      alternates: buildAlternates('/depilacion-mujeres', locale),
      openGraph: buildOpenGraph({ title: seo.metaTitle[locale], description: seo.metaDescription[locale], path: '/depilacion-mujeres', locale }),
...
export default async function Page({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <DepilacionGenderPage locale={lang as Locale} gender="mujeres" />
}
