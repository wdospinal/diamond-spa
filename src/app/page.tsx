...
const HERO_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuARewKYdLJs5kfLjfNo15Y-Bvcc5MYt_OWgbc-2jwqTpu1GtJUy7M56ebUX8jYdld_LWLt91r3URrz6fwYMN0y-IOJKEVXEj2rVUBiP1FDTpB27NkxYGsoz_yPj-7MAfnY9gSBRAy7HMYy6rfQhKgaGShNSaOhxJLpMnyDnV7Sr5nWohja_HikCD8haFT6_jpmzigAFmn_wJDjM-va9Ev_aSE6Tjz8Hq8LTrJyk3-yL5MCGR_uJHTRQS_VMtcNvJ_yHWmYpV-CcqZY2'

const DEEP_TISSUE_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuBf6M3MTJY3a0VyeDXLX3bGIUrp3dUzZ72q0Mwsq2DSjh5TFK7S_w3ZQfi13HzKYpS82VRnve5FDPFxBrM5bHjR_9An8OykQbgQkSqwLcIFOH_e3uBMgeQcutLox_ARI9SUC7MEJ3IuTiegApD9kpAhhJSiiO0xm9TpPFEMuwcyXPSzdabrM1NLD9vfcIZuDbXc8OjO1fRjeFesfZSOoT81xltXvbGp-0gXh211u_ibO8r9EjmbbUxztiNDuxbEo87fRCNeA-CBgr8Y'

const FACIAL_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuAZsfM0QI0GE0BCNgFlTZHmGNftgnas-PXevE9015gW7bzQvQIVWQOTcdU5jYfhdRj5-Lqet2Kbzxoyry1JM8YvamU8Uhxawrd5GA5qL_dp-Q1PaYTgWE6dAWWxPaw4S3ts2q-SPF3cCmOzP2qHW0Yw586Nvheje2jixR2RsXX0BDGLEjgwd-YdJMhbOshStYX07s9n8Yrg08RnjiCE2OFRObikltW3dI3PuyHgi2ocEIq7zAx2BjzJOmqP4sMEwAgdjGd_t7jy1-QO'

const RELAX_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuAT0RW6uduw7sUyBSEesFWEN7RiwIAIzyZ7evCOe38BuXx9qpJveoSj5F0K8h-3mUWeQNlvmHU4cV2hz9ANgwGNdrcQzQjY7GDwt_U0ByilcyE6zT4nAd9lI5xqDwdfCMKf594okejP_rYMw2V7_NBcJbtxvX2Br69pUi8kPrWfmHHW7Yqo2VWCLCV5-eqY74K29QCQpPFnVQAz_2-QdTitbvR3sCaoqurA0gmR_qheugd8WTHveMn82CyIeCREzb1x1VfVZBQZxZ2i'

const BOUTIQUE_IMG =
  'https://lh3.googleusercontent.com/aida-public/AB6AXuDeGR8FHRHdKwBQH-XHXL66xsvphiainpt1lr0JS29n5HIiZDFhmdrhb4WOYalkRGilFAPnBbq5AUoqFEzQCm-RNWQXJbNArkvJTAKSp-47m2ScLWrutdw1H_GNN1O1yQzM-j5zT91RzunQehYHUZQhApdXRTtx8M-DpBaNXL_1J5_ECl8z0zEntw6h5MNFxXW_NatIsHMbIcMn6b9gPlySuZWS6mlLTPLTKvQwR5PdSlc4nno8n6By_oyg0x602FS3LJFtNMBna-AU'
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-screen-2xl mx-auto w-full px-6 md:px-12 pt-10 md:pt-14 pb-24">
          ...
          <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl text-on-surface leading-tight mb-8 max-w-3xl">
            Relax and feel<br />better today.
          </h1>
          <p className="font-body text-secondary text-lg max-w-md leading-relaxed font-light mb-12">
            Precision recovery and mental clarity designed exclusively for the modern professional.
            Experience unparalleled discretion in the heart of the city.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/services"
              className="inline-flex items-center gap-2 border border-outline-variant/30 text-on-surface px-8 py-4 font-label font-bold tracking-[0.2em] text-xs uppercase hover:bg-surface-container-high transition-all duration-300"
            >
              Explore Services
            </Link>
          </div>
      ...
      <section className="py-28 px-6 md:px-12 bg-surface-container-low">
        <div className="max-w-screen-2xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="font-headline text-4xl md:text-5xl text-on-surface">Curated Restoration</h2>
              <p className="mt-4 font-body text-secondary max-w-lg leading-relaxed font-light">
                Every treatment is calibrated to the physiological and psychological needs of men.
                No floral scents, no clutter — just pure architectural calm.
              </p>
            </div>
            <span className="font-label text-primary tracking-[0.3em] uppercase text-xs whitespace-nowrap">
              Premium Standards ——
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-8 relative group overflow-hidden bg-surface-container min-h-[480px]">
              ...
              <img
                ...
                className="w-full h-full object-cover absolute inset-0 img-hover-color"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-surface-container-lowest via-surface/40 to-transparent" />
              <div className="absolute bottom-0 left-0 p-8 z-10">
                <span className="font-label text-tertiary tracking-[0.3em] uppercase text-xs mb-3 block">Recovery</span>
                <h3 className="font-headline text-3xl text-on-surface mb-3">Deep Tissue Massage</h3>
                <p className="font-body text-secondary text-sm max-w-md leading-relaxed mb-5">
                  Targeted release for chronic muscle tension and athletic recovery. We utilise high-pressure
                  techniques to reset the muscular system and improve mobility.
                </p>
                <Link
                  href="/services"
                  className="inline-flex items-center gap-2 font-label text-primary text-xs tracking-widest uppercase hover:gap-3 transition-all"
                >
            ...
            <div className="md:col-span-4 bg-surface-container-high p-8 flex flex-col justify-between min-h-[480px] group overflow-hidden relative">
              <div>
                <span className="font-label text-tertiary tracking-[0.3em] uppercase text-xs mb-3 block">Grooming</span>
                <h3 className="font-headline text-2xl text-on-surface mb-4">Facial Treatments</h3>
                <p className="font-body text-secondary text-sm leading-relaxed">
                  High-performance skin rejuvenation for the modern man. Addressing irritation from shaving,
                  urban pollutants, and fatigue through medical-grade formulas.
                </p>
              </div>
              <div className="mt-8 overflow-hidden">
                ...
                <img
                  ...
                  className="w-full h-48 object-cover object-top img-hover-color"
                />
              </div>
            </div>
            ...
            <div className="md:col-span-12 bg-surface-container relative group overflow-hidden min-h-[280px] flex items-center">
              ...
              <img
                ...
                className="absolute inset-0 w-full h-full object-cover img-hover-color"
              />
              ...
              <div className="relative z-10 px-10 py-10 max-w-2xl">
                <span className="font-label text-tertiary tracking-[0.3em] uppercase text-xs mb-3 block">Clarity</span>
                <h3 className="font-headline text-3xl text-on-surface mb-3">Relaxation Massage</h3>
                <p className="font-body text-secondary text-sm leading-relaxed">
                  A mental reset designed to lower cortisol levels and induce profound relaxation.
                  Perfect for decompressing after high-stakes environments.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-surface-container-high/90 backdrop-blur-sm p-6">
              <p className="font-headline italic text-on-surface text-sm leading-relaxed mb-2">
                &ldquo;The ultimate haven for the traveling executive.&rdquo;
              </p>
              <span className="font-label text-tertiary text-xs tracking-widest uppercase">Forbes Luxury Travel Guide</span>
            </div>
          </div>
        </div>
      </section>
